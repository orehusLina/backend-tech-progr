...
def upgrade() -> None:
    ...
    sa.Column('organization_name', sa.VARCHAR(length=50), nullable=True),
    ...
    sa.Column('contact_name', sa.VARCHAR(length=50), nullable=True),
    ...
    sa.Column('field_of_study', sa.VARCHAR(length=50), nullable=True),
